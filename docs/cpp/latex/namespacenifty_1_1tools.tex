...
\begin{DoxyParamCaption}
\item[{const marray\+::\+View$<$ T $>$ \&}]{data\+In, }
\item[{marray\+::\+View$<$ T $>$ \&}]{data\+Out}
\end{DoxyParamCaption}
...
\begin{DoxyParamCaption}
\item[{marray\+::\+View$<$ T $>$}]{array, }
\item[{const C\+O\+O\+R\+D \&}]{begin\+Coord, }
\item[{const C\+O\+O\+R\+D \&}]{end\+Coord, }
\item[{const marray\+::\+View$<$ T $>$ \&}]{data}
\end{DoxyParamCaption}
...
\item[{const C\+O\+O\+R\+D \&}]{begin\+Coord, }
\item[{const C\+O\+O\+R\+D \&}]{end\+Coord, }
\item[{const marray\+::\+View$<$ T $>$ \&}]{subarray}
\end{DoxyParamCaption}
