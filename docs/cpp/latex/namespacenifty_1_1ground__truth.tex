...
\item[{const {\bf marray\+::\+View}$<$ T\+\_\+\+S\+E\+G $>$ \&}]{segmentation, }
\item[{std\+::vector$<$ std\+::array$<$ int32\+\_\+t, 2 $>$ $>$ \&}]{edges, }
\item[{{\bf marray\+::\+View}$<$ uint8\+\_\+t $>$ \&}]{lifted\+Edges\+State}
...
\begin{DoxyParamCaption}
\item[{const {\bf marray\+::\+View}$<$ T $>$ \&}]{segmentation, }
\item[{{\bf marray\+::\+View}$<$ U $>$ \&}]{edges}
\end{DoxyParamCaption}
...
\begin{DoxyParamCaption}
\item[{const {\bf marray\+::\+View}$<$ T\+\_\+\+S\+E\+G $>$ \&}]{segmentation, }
\item[{const {\bf marray\+::\+View}$<$ T\+\_\+\+D\+T $>$ \&}]{dt, }
\item[{{\bf marray\+::\+View}$<$ T\+\_\+\+O\+U\+T $>$ \&}]{out, }
