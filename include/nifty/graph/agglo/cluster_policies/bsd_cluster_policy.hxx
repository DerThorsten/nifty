...
>
class BsdClusterPolicy{

    typedef BsdClusterPolicy<
...
public:
    ...
    typedef xt::xtensor<float, 2>                       NodeFeaturesType;
...
public:
    ...
    template<
        class MERGE_PRIOS, 
        class NOT_MERGE_PRIOS, 
        class IS_LOCAL_EDGE, 
        class EDGE_SIZES,
        class NODE_FEATURES,
        class NODE_SIZES
    >
    BsdClusterPolicy(const GraphType &, 
                     const MERGE_PRIOS & , 
...
template<class MERGE_PRIOS, class NOT_MERGE_PRIOS, class IS_LOCAL_EDGE,class EDGE_SIZES, class NODE_FEATURES, class NODE_SIZES>
inline BsdClusterPolicy<GRAPH, ACC_0, ACC_1,ENABLE_UCM>::
BsdClusterPolicy(
...
BsdClusterPolicy<GRAPH, ACC_0, ACC_1,ENABLE_UCM>::
...
template<class GRAPH, class ACC_0, class ACC_1, bool ENABLE_UCM>
inline bool 
BsdClusterPolicy<GRAPH, ACC_0, ACC_1,ENABLE_UCM>::isDone(
){
...
pqMergePrio(
    ...
    return isLocalEdge_[edge] ?  
        0.5*(acc0_[edge] + (1.0 - acc1_[edge])): 
...
template<class GRAPH, class ACC_0, class ACC_1, bool ENABLE_UCM>
inline typename BsdClusterPolicy<GRAPH, ACC_0, ACC_1,ENABLE_UCM>::EdgeContractionGraphType & 
BsdClusterPolicy<GRAPH, ACC_0, ACC_1,ENABLE_UCM>::
