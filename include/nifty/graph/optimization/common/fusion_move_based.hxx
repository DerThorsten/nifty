...
namespace common{
    ...
    template<
        class OBJECTIVE, 
        class SOLVER_BASE, 
        class DEFAULT_PROPOSAL_GENERATOR_TYPE,
        class FUSION_MOVE_TYPE
    >
    class FusionMoveBased : public SOLVER_BASE
    {
    public: 
        ...
        typedef typename Graph:: template NodeMap<uint64_t> ProposalType;


        typedef ProposalGeneratorBase<ProposalType> ProposalGeneratorBaseType;
    ...
    private:
        typedef FUSION_MOVE_TYPE FusionMoveType;
