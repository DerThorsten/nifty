...
#include "nifty/graph/optimization/mincut/mincut_minCutFactory.hxx"
...
namespace common{
    ...
    public:
        ...
        {
            if(!bool(settings_.minCutFactory)){
                throw std::runtime_error("minCutFactory shall not be empty");
            }
        }
