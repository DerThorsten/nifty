...
#include "nifty/python/graph/opt/ho_multicut/py_multicut_visitor_base.hxx"
...
namespace ho_multicut{
    ...
    void exportHoMulticutVisitorBaseT(py::module & module) {

        typedef OBJECTIVE                                 ObjectiveType;
        typedef HoMulticutBase<ObjectiveType>             SolverBaseType;
        typedef PyHoMulticutVisitorBase<ObjectiveType>    PyVisitorBaseType;
        typedef HoMulticutVisitorBase<ObjectiveType>      VisitorBaseType;
        ...
        
        {
            ...
            typedef HoMulticutVerboseVisitor<ObjectiveType> VisitorType; 
    ...
    void exportHoMulticutVisitorBase(py::module & module) {

        {
            typedef PyUndirectedGraph GraphType;
            typedef HoMulticutObjective<GraphType, double> ObjectiveType;
            exportHoMulticutVisitorBaseT<ObjectiveType>(module);
        }
        {
