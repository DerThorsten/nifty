...
#include "nifty/graph/agglo/cluster_policies/bsd_cluster_policy.hxx"
...
namespace agglo{
    ...
    void exportBsdClusterPolicyTT(py::module & aggloModule) {
        ...
        {   
            ...
            typedef BsdClusterPolicy<GraphType, ACC_0, ACC_1, WITH_UCM> ClusterPolicyType;
            ...
            aggloModule.def(clusterPolicyFacName.c_str(),
                [](
                    ...
                    const xt::pytensor<float,  1> & mergePrios,
                    const xt::pytensor<float,  1> & notMergePrios,
                    const xt::pytensor<uint8_t,1> & isLocalEdge,
                    const xt::pytensor<float,  1> & edgeSizes,
                    const xt::pytensor<float,  2> & nodeFeatures,
                    const xt::pytensor<float,  1> & nodeSizes,
                    ...
                    s.zeroInit = zeroInit;
                    auto ptr = new ClusterPolicyType(graph, mergePrios, notMergePrios, isLocalEdge, edgeSizes, nodeFeatures, nodeSizes, s);
                    return ptr;
                },
    ...
    //oid exportBsdClusterPolicyT(py::module & aggloModule) {
    //   exportBsdClusterPolicyTT<GRAPH, ACC_0, ACC_1, false>(aggloModule);
    ...
    void exportBsdClusterPolicyOuter(py::module & aggloModule) {
        typedef GRAPH GraphType;
        ...
        exportBsdClusterPolicyTT<GraphType, ACC_0, ArithmeticMeanAcc,  false>(aggloModule);
        //exportBsdClusterPolicyTT<GraphType, ACC_0, GeneralizedMeanAcc, false>(aggloModule);
        //exportBsdClusterPolicyTT<GraphType, ACC_0, SmoothMaxAcc,       false>(aggloModule);
        //exportBsdClusterPolicyTT<GraphType, ACC_0, RankOrderAcc,       false>(aggloModule);
        //exportBsdClusterPolicyTT<GraphType, ACC_0, MaxAcc,             false>(aggloModule);
        //exportBsdClusterPolicyTT<GraphType, ACC_0, MinAcc,             false>(aggloModule);
    }
    ...
    void exportDualAgglomerativeClustering(py::module & aggloModule) {
        {
            ...
            exportBsdClusterPolicyOuter<GraphType, ArithmeticMeanAcc >(aggloModule);
            //exportBsdClusterPolicyOuter<GraphType, SmoothMaxAcc      >(aggloModule);
            //exportBsdClusterPolicyOuter<GraphType, GeneralizedMeanAcc>(aggloModule);
            //exportBsdClusterPolicyOuter<GraphType, RankOrderAcc      >(aggloModule);
            //exportBsdClusterPolicyOuter<GraphType, MaxAcc            >(aggloModule);
            //exportBsdClusterPolicyOuter<GraphType, MinAcc            >(aggloModule);
