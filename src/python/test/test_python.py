...
def impl_edge_contraction_graph_inference(fmSubFac):
    ...
    while cg.numberOfEdges != 0:
        ...
        print("numberOfNodes",cg.numberOfNodes)
...
def test_edge_contraction_graph_inference_fm_greedy():
    ...
    impl_edge_contraction_graph_inference(fmSubFac=None)
...
if nifty.Configuration.WITH_CPLEX:
   ...
   def test_edge_contraction_graph_inference_cplex():
       ...
       impl_edge_contraction_graph_inference(fmSubFac=fmSubFac)
